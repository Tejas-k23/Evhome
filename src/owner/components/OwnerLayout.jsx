...
const OwnerLayout = () => {
    ...
    const menuItems = [
        ...
        { path: '/owner/stations', icon: <MapPin size={20} />, label: 'My Stations' },
        { path: '/owner/bookings', icon: <CalendarCheck size={20} />, label: 'Bookings' },
        { path: '/owner/sessions', icon: <Zap size={20} />, label: 'Live Sessions' },
        { path: '/owner/revenue', icon: <IndianRupee size={20} />, label: 'Revenue' },
    ];

    const toggleSidebar = () => setIsSidebarOpen(!isSidebarOpen);

    return (
        <div className="owner-layout" style={{ display: 'flex', minHeight: '100vh', background: '#F8FAFC' }}>
            {/* Sidebar */}
            <aside style={{
                ...
                <div style={{
                    ...
                    {isSidebarOpen && <span style={{ fontWeight: '800', fontSize: '20px', letterSpacing: '1px' }}>EV HOME <span style={{ color: '#22C55E' }}>OWNER</span></span>}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            <div style={{ textAlign: 'right' }}>
                                <p style={{ fontSize: '14px', fontWeight: '600', color: '#1E293B', margin: 0 }}>{owner?.name || 'Station Owner'}</p>
                                <p style={{ fontSize: '12px', color: '#64748B', margin: 0 }}>Owner Panel</p>
                            </div>
                            <div style={{
                                width: '40px',
                                height: '40px',
